...
<h1>
    <p align="center">
        <a href="https://heroku.com/deploy?template=https://github.com/RBBOTDEVELOPER/WilliamButcherBot">
...
```console
thehamkercat@arch:~$ git clone https://github.com/RBBOTDEVELOPER/WilliamButcherBot
thehamkercat@arch:~$ cd WilliamButcherBot
